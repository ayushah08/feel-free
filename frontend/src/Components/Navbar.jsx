  ...
  return (
    <div className=' w-100% flex items-center justify-between m-1 rounded-2xl bg-white shadow-[0_0_15px_lightgray]'>
      <div className='text-1xl font-bold flex items-center gap-1 pl-2'>
         <span className='h-10 w-10 rounded-2xl bg-linear-to-r from-[#8b5cf6] via-[#d946ef] to-[#ec4899] 
          flex items-center justify-center text-white'><HeartHandshake size={30} strokeWidth={2} /></span>
        <span className=''>FeelFree.<span className='bg-clip-text text-transparent bg-linear-to-r from-[#8b5cf6] via-[#d946ef] to-[#ec4899]'>Ai</span></span>
      </div>
      ...
      <div className='flex items-center'>
        ...
        <span className='bg-clip-text font-bold text-transparent text-2xl bg-linear-to-r from-[#8b5cf6] via-[#d946ef] to-[#ec4899]'>3</span>
      </div>
    </div>
  )
}
